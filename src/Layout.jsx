...
//         </Box>
//       </Drawer>
//       <Box sx={{ paddingBottom: botOpen ? "80px" : "16px" }}> {children}</Box>
//       <Snackbar
//         open={snackbarOpen}
...
//                 <IconButton
//                   color="inherit"
//                   onClick={() => setBotOpen((prev) => !prev)} // Toggle chatbot visibility
//                   sx={{ ml: 2 }}
//                 >
//                   <img
//                     src={botOpen ? "../../image.png" : "../../robot.png"}
//                     alt={botOpen ? "Close Chatbot" : "Open Chatbot"}
//                     height={40}
//                     width={40}
//                   />
...
//             {/* Add Help Icon to open the chatbot */}
//           </Box>
//         </Toolbar>
//       </AppBar>
//       <Drawer
...
const Layout = ({ children }) => {
  ...
  return (
    ...
    >
      <AppBar position="static" sx={{ backgroundColor: "red", height: 60 }}>
        <Toolbar sx={{ justifyContent: "space-between" }}>
